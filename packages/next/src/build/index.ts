...
export default async function build(
  ...
  try {
    ...
    await nextBuildSpan.traceAsyncFn(async () => {
      ...
      const paths = {
        additional: new Map<string, GeneratedStaticPath[]>(),
        static: new Map<string, GeneratedStaticPath[]>(),
      }
                      ...
                      if (pageType === 'app' && originalAppPath) {
                        ...
                        if (isEdgeRuntime(pageRuntime)) {
                          ...
                          if (
                            ...
                            workerResult.generatedRoutes.length > 0
                          ) {
                            paths.static.set(
                              originalAppPath,
                              workerResult.generatedRoutes
      ...
      const isApp404Static = paths.static.has(UNDERSCORE_NOT_FOUND_ROUTE_ENTRY)
      ...
      if (
        ...
        await staticGenerationSpan.traceAsyncFn(async () => {
          detectConflictingPaths(
            ...
            ssgPages,
            new Map(
              Array.from(paths.additional.entries()).map(
          ...
          const exportConfig: NextConfigComplete = {
            ...
            exportPathMap: (defaultMap: ExportPathMap) => {
              ...
              // post slugs.
              paths.additional.forEach((routes, page) => {
              ...
              paths.static.forEach((routes, originalAppPath) => {
          ...
          for (const page of combinedPages) {
            ...
            if (isSsg) {
              ...
              if (!isDynamic) {
                ...
                for (const route of paths.additional.get(page) ?? []) {
